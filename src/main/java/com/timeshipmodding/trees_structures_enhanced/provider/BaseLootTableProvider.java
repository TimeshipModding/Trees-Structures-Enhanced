package com.timeshipmodding.trees_structures_enhanced.provider;

import com.timeshipmodding.trees_structures_enhanced.TreeStructuresEnhanced;
import com.timeshipmodding.trees_structures_enhanced.datagen.LootTables;
...
public class BaseLootTableProvider extends VanillaBlockLoot {
    ...
    protected Iterable<Block> getKnownBlocks() {
        return ForgeRegistries.BLOCKS.getEntries().stream()
                .filter(e -> e.getKey().location().getNamespace().equals(TreeStructuresEnhanced.MODID))
